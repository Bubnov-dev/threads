    ...
    , ui(new Ui::MainWindow)
{
    ...
    thread=new QThread();
    bubble=new BubbleSort(nullptr,array,n);
...
void MainWindow::createArray()
{
    ...
    for(int i=0;i<n;i++)
        array[i]=generator.bounded(1,1000000);
}
...
void MainWindow::sortArray()
{
    ...
    connect(timer,&QTimer::timeout,bubble,&BubbleSort::getArray, Qt::DirectConnection);
    connect(bubble,&BubbleSort::nowArray,this,&MainWindow::getArray, Qt::DirectConnection);
    connect(bubble,&BubbleSort::finished,this,&MainWindow::stopTimer);
    connect(bubble,&BubbleSort::finished,bubble,&BubbleSort::getArray, Qt::DirectConnection);
...
void MainWindow::getArray(int *arr)
{
    array=arr;
    series->remove(set);
